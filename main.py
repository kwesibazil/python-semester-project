...
algorithm = StringVar()
algorithm.set("Depth first search")
label = Label(window, text="Search Algorithm: ", font="Times 20 italic bold").grid(row=0, column=1, sticky="n", pady=(0,15), padx=(0,15)) 
option = OptionMenu(window, algorithm, "Depth first search", "Breadth first search", "A* Search", command=OptionMenuEvent)
option.grid(row=0,column=2,sticky="n")
